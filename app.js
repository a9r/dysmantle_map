...
// ── 冥界 (dlc1) ──
const MD_DLC1=[
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:454,gy:66,n:'水晶洞穴',r:'dlc1',d:'营火 (454° ,66°) Crystal Caves'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:458,gy:69,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (458° ,69°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:466,gy:67,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (466° ,67°)'},
  {tp:'resource',ic:'icon-mana-chamber',cl:'#a78bfa',gx:478,gy:68,n:'法力室',r:'dlc1',d:'神力室 (478° ,68°) Enemy Drops: [2 x Plant Matter] Random Enemy Drops: [1 x Scrap Wood, 1 x Sc'},
  {tp:'boss',ic:'icon-boss',cl:'#ef4444',gx:481,gy:65,n:'狡猾骗子',r:'dlc1',d:'BOSS (481° ,65°) The Slick Swindler'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:626,gy:78,n:'安全港湾',r:'dlc1',d:'营火 (626° ,78°) Safe Haven'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:633,gy:75,n:'神力钓点',r:'dlc1',d:'钓鱼点 (633° ,75°) Mana Spot'},
  {tp:'farmable',ic:'icon-farmable',cl:'#4ade80',gx:366,gy:99,n:'可耕种',r:'dlc1',d:'Farmable (366° ,100°)'},
  {tp:'resource',ic:'icon-energy-relay',cl:'#67e8f9',gx:661,gy:94,n:'能量中继',r:'dlc1',d:'能量继电器 (661° ,94°)'},
  ...
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:366,gy:102,n:'使用增强型种子袋',r:'dlc1',qid:'q_dlc1_516186',qt:'side',d:'支线任务 (366° ,102°) Farming with Enhanced Seed Bag'},
  ...
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:673,gy:104,n:'可修复',r:'dlc1',d:'吊桥 (673° ,104°)'},
  {tp:'resource',ic:'icon-mana-chamber',cl:'#a78bfa',gx:664,gy:110,n:'法力室',r:'dlc1',d:'神力室 (664° ,110°) Enemy Drops: [5 x Plant Matter, 1 x Common Roach, 1 x Red Herring, 1 x Lum'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:674,gy:108,n:'神力钓点',r:'dlc1',d:'钓鱼点 (674° ,108°) Mana Spot'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:683,gy:109,n:'锯木厂建设基础',r:'dlc1',qid:'q_dlc1_548169',qt:'side',d:'支线任务 (684° ,109°) Sawmill Building Basics'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:384,gy:123,n:'可修复',r:'dlc1',d:'Fixable (384° ,123°) Required Materials: [3 x Lumber]'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:391,gy:128,n:'隐秘工坊',r:'dlc1',d:'营火 (391° ,128°) Hidden Workshop'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:538,gy:120,n:'一瞥之地',r:'dlc1',d:'营火 (538° ,120°) Glimpse'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:667,gy:136,n:'分裂殖民地',r:'dlc1',d:'营火 (667° ,136°) Colony of the Divided'},
  ...
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:746,gy:137,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (746° ,137°) Drops: [10 x Bone, 10 x Meat]'},
  ...
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:483,gy:142,n:'神力钓点',r:'dlc1',d:'钓鱼点 (483° ,142°) Mana Spot'},
  ...
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:676,gy:142,n:'冥界命运',r:'dlc1',d:'音频日志 (676° ,142°) Underworld Fate'},
  ...
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:794,gy:157,n:'拾荒小镇',r:'dlc1',d:'营火 (794° ,157°) Scavenger Hamlet'},
  ...
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:532,gy:175,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (532° ,175°) Drops: [5 x Red Mushroom, 5 x Electronics, 2 x Lumber]'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:736,gy:162,n:'神力钓点',r:'dlc1',d:'钓鱼点 (736° ,162°) Mana Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:765,gy:179,n:'传说级神力钓点',r:'dlc1',d:'钓鱼点 (765° ,179°) Legendary Mana Spot'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:793,gy:165,n:'往事储存库',r:'dlc1',qid:'q_dlc1_846171',qt:'side',d:'支线任务 (793° ,165°) Vault into Past'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:814,gy:162,n:'神力钓点',r:'dlc1',d:'钓鱼点 (814° ,162°) Mana Spot'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:470,gy:184,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (470° ,184°) Drops: [15 x Rubber, 5 x Electronics]'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:650,gy:186,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (650° ,186°) Drops: [2 x Steel, 10 x Fabric]'},
  {tp:'resource',ic:'icon-buried-teleporter',cl:'#c084fc',gx:658,gy:193,n:'传送宝藏',r:'dlc1',d:'埋藏宝藏 (658° ,193°) To: Blade Runner\'s Maze'},
  {tp:'resource',ic:'icon-unknown',cl:'#94a3b8',gx:773,gy:194,n:'',r:'dlc1',d:'Doghouse (773° ,194°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:376,gy:208,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (376° ,208°) Drops: [1 x Mana Shard, 5 x Fabric]'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:396,gy:208,n:'优质钓点',r:'dlc1',d:'钓鱼点 (396° ,208°) Good Spot'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:572,gy:207,n:'冥界传言',r:'dlc1',d:'音频日志 (572° ,207°) Underworld Rumors'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:606,gy:217,n:'冥界医生',r:'dlc1',d:'音频日志 (606° ,217°) Underworld Doc'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:634,gy:212,n:'可修复',r:'dlc1',d:'Fixable (634° ,212°) Required Materials: [4 x Lumber]'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:623,gy:215,n:'断裂铁路',r:'dlc1',d:'营火 (623° ,215°) Broken Railroad'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:656,gy:206,n:'可修复',r:'dlc1',d:'吊桥 (656° ,206°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:665,gy:215,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (665° ,215°) Drops: [3 x Steel, 5 x Rubber]'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:725,gy:219,n:'限时箱子',r:'dlc1',d:'限时箱子 (725° ,219°) Time Available: 18 seconds Rewards: [1 x Mana Chunk, 2 x Titanium]'},
  {tp:'resource',ic:'icon-wishing-well',cl:'#f0abfc',gx:754,gy:218,n:'许愿井',r:'dlc1',d:'Wishing Well (754° ,218°)'},
  {tp:'resource',ic:'icon-hatch',cl:'#94a3b8',gx:797,gy:213,n:'避难所',r:'dlc1',d:'避难所 (797° ,213°)'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:788,gy:215,n:'限时箱子',r:'dlc1',d:'限时箱子 (788° ,215°) Time Available: 27 seconds Rewards: [6 x Lumber, 10 x Steel, 1 x Mana Chunk'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:807,gy:216,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (807° ,216°) Drops: [4 x Steel, 12 x Rubber, 25 x Ceramics]'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:842,gy:215,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (842° ,215°) Drops: [5 x Mana Bead, 2 x Titanium]'},
  {tp:'resource',ic:'icon-buried-teleporter',cl:'#c084fc',gx:396,gy:235,n:'传送宝藏',r:'dlc1',d:'埋藏宝藏 (396° ,235°) To: The Perilous Labyrinth'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:464,gy:236,n:'优质钓点',r:'dlc1',d:'钓鱼点 (464° ,236°) Good Spot'},
  {tp:'resource',ic:'icon-mana-chamber',cl:'#a78bfa',gx:508,gy:228,n:'法力室',r:'dlc1',d:'神力室 (508° ,228°) Enemy Drops: [1 x Fabric, 2 x Wood, 1 x Wood, 1 x Scrap Fabric, 2 x Iron, '},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:610,gy:223,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (610° ,223°)'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:640,gy:226,n:'锯木厂建设基础',r:'dlc1',qid:'q_dlc1_1118254',qt:'side',d:'支线任务 (640° ,226°) Sawmill Building Basics'},
  ...
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:729,gy:223,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (729° ,223°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:774,gy:235,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (774° ,235°)'},
  {tp:'resource',ic:'icon-entryway',cl:'#86efac',gx:99,gy:251,n:'冥界岛入口',r:'dlc1',d:'Entryway (99° ,251°) Underworld Island Entrance'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:112,gy:240,n:'终末岛',r:'dlc1',d:'营火 (112° ,240°) Island In the End'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:357,gy:256,n:'海岸高地',r:'dlc1',d:'营火 (357° ,256°) Beachtop'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:376,gy:252,n:'神力钓点',r:'dlc1',d:'钓鱼点 (376° ,252°) Mana Spot'},
  {tp:'resource',ic:'icon-mana-chamber',cl:'#a78bfa',gx:414,gy:251,n:'法力室',r:'dlc1',d:'神力室 (414° ,251°) Enemy Drops: [2 x Rubber, 4 x Iron, 2 x Lumber, 1 x Scrap Fabric, 1 x Plas'},
  ...
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:449,gy:241,n:'老爷车车站',r:'dlc1',d:'营火 (449° ,241°) Jalopy Station'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:501,gy:258,n:'失守路障',r:'dlc1',d:'营火 (501° ,258°) Overrun Barricades'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:538,gy:248,n:'可修复',r:'dlc1',d:'吊桥 (538° ,248°)'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:573,gy:248,n:'可修复',r:'dlc1',d:'吊桥 (573° ,248°)'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:608,gy:251,n:'封口机',r:'dlc1',d:'链塔 (608° ,251°) Capper'},
  {tp:'resource',ic:'icon-energy-relay',cl:'#67e8f9',gx:612,gy:255,n:'能量中继',r:'dlc1',d:'能量继电器 (612° ,255°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:736,gy:252,n:'孤独盆地',r:'dlc1',d:'营火 (736° ,252°) Basin of Solitude'},
  ...
  {tp:'resource',ic:'icon-mana-chamber',cl:'#a78bfa',gx:836,gy:257,n:'法力室',r:'dlc1',d:'神力室 (836° ,257°) Enemy Drops: [1 x Lobster, 1 x Lobster, 1 x Lumber, 2 x Wood, 1 x Mana Bea'},
  {tp:'resource',ic:'icon-energy-relay',cl:'#67e8f9',gx:885,gy:242,n:'能量中继',r:'dlc1',d:'能量继电器 (885° ,242°)'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:414,gy:264,n:'可修复',r:'dlc1',d:'吊桥 (414° ,264°)'},
  {tp:'resource',ic:'icon-energy-relay',cl:'#67e8f9',gx:449,gy:270,n:'能量中继',r:'dlc1',d:'能量继电器 (449° ,270°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:558,gy:280,n:'克朗斯维尔',r:'dlc1',d:'营火 (558° ,280°) Crownsville'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:614,gy:262,n:'象牙山',r:'dlc1',d:'营火 (614° ,262°) Ivory Mountain Co.'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:688,gy:270,n:'德克斯特',r:'dlc1',d:'链塔 (688° ,270°) Dexter'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:725,gy:271,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (725° ,271°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:761,gy:260,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (761° ,260°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:798,gy:276,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (798° ,276°) Drops: [1 x Mana Shard, 12 x Lumber]'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:851,gy:279,n:'荒凉农场',r:'dlc1',d:'营火 (851° ,279°) Farm of Desolation'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:398,gy:286,n:'可修复',r:'dlc1',d:'吊桥 (398° ,286°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:384,gy:281,n:'缠结海岸',r:'dlc1',d:'营火 (384° ,281°) Knot Shores'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:426,gy:287,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (426° ,287°) Drops: [8 x Iron, 8 x Rubber, 1 x Mana Bead]'},
  {tp:'resource',ic:'icon-mana-chamber',cl:'#a78bfa',gx:494,gy:298,n:'法力室',r:'dlc1',d:'神力室 (494° ,298°) Enemy Drops: [2 x Rubber, 2 x Iron, 1 x Fabric, 1 x Lobster, 1 x Steel, 3 '},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:521,gy:292,n:'可修复',r:'dlc1',d:'吊桥 (521° ,292°)'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:540,gy:283,n:'冥界分界',r:'dlc1',d:'音频日志 (540° ,283°) Underworld Divide'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:586,gy:290,n:'冥界象牙山',r:'dlc1',d:'音频日志 (586° ,290°) Underworld Ivory'},
  ...
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:748,gy:296,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (748° ,296°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:772,gy:283,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (772° ,283°)'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:828,gy:286,n:'可修复',r:'dlc1',d:'吊桥 (828° ,286°)'},
  ...
  {tp:'resource',ic:'icon-energy-relay',cl:'#67e8f9',gx:554,gy:315,n:'能量中继',r:'dlc1',d:'能量继电器 (554° ,315°)'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:556,gy:300,n:'可修复',r:'dlc1',d:'吊桥 (556° ,300°)'},
  ...
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:620,gy:311,n:'使用增强型种子袋',r:'dlc1',qid:'q_dlc1_1502119',qt:'side',d:'支线任务 (620° ,312°) Farming with Enhanced Seed Bag'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:640,gy:313,n:'限时箱子',r:'dlc1',d:'限时箱子 (640° ,313°) Time Available: 30 seconds Rewards: [1 x Blue Eye Orb, 1 x Titanium]'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:665,gy:306,n:'亡灵峡谷',r:'dlc1',d:'营火 (665° ,306°) Gorge of the Undead'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:721,gy:312,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (721° ,312°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:782,gy:310,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (782° ,310°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:782,gy:312,n:'传说级神力钓点',r:'dlc1',d:'钓鱼点 (782° ,312°) Legendary Mana Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:813,gy:313,n:'神力钓点',r:'dlc1',d:'钓鱼点 (814° ,313°) Mana Spot'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:801,gy:318,n:'限时箱子',r:'dlc1',d:'限时箱子 (801° ,318°) Time Available: 29 seconds Rewards: [2 x Titanium, 10 x Lumber]'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:487,gy:334,n:'绝望的存在',r:'dlc1',qid:'q_dlc1_1584342',qt:'side',d:'支线任务 (487° ,334°) Desperate Existence'},
  {tp:'resource',ic:'icon-lock',cl:'#4ade80',gx:549,gy:321,n:'',r:'dlc1',d:'Locked Door (549° ,321°) Town Station Key'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:576,gy:338,n:'可修复',r:'dlc1',d:'吊桥 (576° ,338°)'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:564,gy:327,n:'冥界继电器',r:'dlc1',d:'音频日志 (564° ,327°) Underworld Relays'},
  {tp:'resource',ic:'icon-unknown',cl:'#94a3b8',gx:590,gy:325,n:'',r:'dlc1',d:'Doghouse (590° ,325°)'},
  {tp:'resource',ic:'icon-buried-teleporter',cl:'#c084fc',gx:642,gy:334,n:'传送宝藏',r:'dlc1',d:'埋藏宝藏 (642° ,334°) To: The Abandoned Maze'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:723,gy:339,n:'冥界精灵',r:'dlc1',d:'音频日志 (723° ,339°) Underworld Spirits'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:739,gy:328,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (739° ,328°) Drops: [1 x Mana Shard, 4 x Titanium, 30 x Plastics]'},
  ...
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:771,gy:339,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (771° ,339°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:799,gy:330,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (799° ,330°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:420,gy:356,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (420° ,356°) Drops: [5 x Hide, 5 x Fabric]'},
  {tp:'resource',ic:'icon-energy-relay',cl:'#67e8f9',gx:451,gy:356,n:'能量中继',r:'dlc1',d:'能量继电器 (451° ,356°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:480,gy:346,n:'通道谷',r:'dlc1',d:'营火 (480° ,346°) Passage Valley'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:526,gy:358,n:'熔炉建设基础',r:'dlc1',qid:'q_dlc1_1684049',qt:'side',d:'支线任务 (526° ,358°) Smelter Building Basics'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:542,gy:343,n:'可修复',r:'dlc1',d:'Fixable (542° ,343°) Required Materials: [3 x Lumber]'},
  {tp:'resource',ic:'icon-mana-chamber',cl:'#a78bfa',gx:697,gy:347,n:'法力室',r:'dlc1',d:'神力室 (697° ,347°) Enemy Drops: [1 x Blue Eye Orb] Random Enemy Drops: [1 x Blue Eye Orb]'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:696,gy:345,n:'精神问题',r:'dlc1',qid:'q_dlc1_1700229',qt:'key',d:'主线任务 (696° ,345°) Spirit Trouble'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:449,gy:366,n:'邪恶的',r:'dlc1',d:'链塔 (449° ,366°) Sinister'},
  ...
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:730,gy:362,n:'破碎郊区',r:'dlc1',d:'营火 (730° ,362°) Shattered Suburbs'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:758,gy:374,n:'神力裂隙',r:'dlc1',d:'神力裂隙 (758° ,374°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:788,gy:362,n:'神力钓点',r:'dlc1',d:'钓鱼点 (788° ,362°) Mana Spot'},
  ...
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:509,gy:382,n:'神力钓点',r:'dlc1',d:'钓鱼点 (509° ,382°) Mana Spot'},
  ...
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:582,gy:384,n:'盗贼崖',r:'dlc1',d:'营火 (582° ,384°) Scarp of Thieves'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:427,gy:414,n:'冥界入口',r:'dlc1',d:'营火 (427° ,414°) Underworld Entryway'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:435,gy:411,n:'冥界探索者',r:'dlc1',d:'音频日志 (435° ,411°) Underworld Explorers'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:506,gy:410,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (506° ,410°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:553,gy:407,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (553° ,407°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:564,gy:413,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (564° ,413°) Required Quest: Desperate Existence [Side Quest] Drops: [1 x Scrap Fabr'},
  {tp:'resource',ic:'icon-entryway',cl:'#86efac',gx:402,gy:423,n:'冥界入口',r:'dlc1',d:'Entryway (402° ,423°) Entrance Underworld'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:448,gy:437,n:'埋藏宝藏',r:'dlc1',d:'埋藏宝藏 (448° ,437°) Drops: [5 x Hide, 5 x Rubber]'},
  {tp:'resource',ic:'icon-buried-teleporter',cl:'#c084fc',gx:516,gy:433,n:'传送宝藏',r:'dlc1',d:'埋藏宝藏 (516° ,433°)'},
  {tp:'resource',ic:'icon-mana-chamber',cl:'#a78bfa',gx:552,gy:426,n:'法力室',r:'dlc1',d:'神力室 (552° ,426°) Enemy Drops: [1 x Blue Eye Orb] Random Enemy Drops: [1 x Blue Eye Orb]'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:516,gy:443,n:'神力钓点',r:'dlc1',d:'钓鱼点 (516° ,443°) Mana Spot'},
];
...
// ── 末日 (dlc2) ──
const MD_DLC2=[
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:194,gy:49,n:'末日普通钓点',r:'dlc2',d:'钓鱼点 (194° ,49°) Doomsday\'s Common Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:315,gy:57,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (315° ,57°) Doomsday\'s Good Spot'},
  {tp:'resource',ic:'icon-hatch',cl:'#94a3b8',gx:211,gy:74,n:'避难所',r:'dlc2',d:'避难所 (211° ,74°)'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:461,gy:79,n:'终端',r:'dlc2',d:'终端 (462° ,79°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:189,gy:97,n:'混凝土丛林',r:'dlc2',d:'营火 (189° ,97°) The Concrete Forest'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:217,gy:99,n:'DLC2 简介',r:'dlc2',d:'音频日志 (217° ,99°) Dlc2 Introduction'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:307,gy:85,n:'限时箱子',r:'dlc2',d:'限时箱子 (307° ,85°) Time Available: 15 seconds Rewards: [1 x Blue Eye Orb]'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:343,gy:89,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (343° ,89°) Drops: [2 x Lumber, 2 x Steel]'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:376,gy:88,n:'可修复',r:'dlc2',d:'吊桥 (376° ,88°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:479,gy:95,n:'海岸实验室内部',r:'dlc2',d:'营火 (479° ,95°) Coastlab Interior'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:542,gy:99,n:'末日传说钓点',r:'dlc2',d:'钓鱼点 (542° ,99°) Doomsday\'s Legendary Spot'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:244,gy:100,n:'诺娜综合体内部入口',r:'dlc2',d:'营火 (244° ,100°) Nona Complex Interior Entrance'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:330,gy:110,n:'后勤区',r:'dlc2',d:'营火 (330° ,110°) Logistics Area'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:333,gy:109,n:'DLC2 成功',r:'dlc2',d:'音频日志 (333° ,109°) Dlc2 Success'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:344,gy:110,n:'限时箱子',r:'dlc2',d:'限时箱子 (344° ,110°) Time Available: 11 seconds Rewards: [8 x Electronics, 6 x Gold Ore]'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:476,gy:102,n:'海岸实验室入口终端',r:'dlc2',d:'终端 (476° ,102°) Coastlab Entrance Terminal'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:196,gy:133,n:'限时箱子',r:'dlc2',d:'限时箱子 (196° ,133°) Time Available: 15 seconds Rewards: [1 x Blue Eye Orb]'},
  {tp:'resource',ic:'icon-fabricator',cl:'#4ade80',gx:208,gy:122,n:'配方：[光束枪]',r:'dlc2',d:'制造厂 (208° ,122°) Recipe: [Beam Gun]'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:276,gy:136,n:'诺娜防御系统测试场终端',r:'dlc2',d:'终端 (276° ,136°) Nona Defensive System Test Range Terminal'},
  {tp:'boss',ic:'icon-boss',cl:'#ef4444',gx:271,gy:123,n:'计算机辅助瞄准系统',r:'dlc2',d:'BOSS (271° ,123°) Computer Assisted Targeting System'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:444,gy:128,n:'跟着流走',r:'dlc2',qid:'q_dlc2_620311',qt:'side',d:'支线任务 (444° ,128°) Go With the Flow'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:484,gy:126,n:'优质钓点',r:'dlc2',d:'钓鱼点 (484° ,126°) Good Spot'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:806,gy:139,n:'神力裂隙',r:'dlc2',d:'神力裂隙 (806° ,139°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:116,gy:151,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (116° ,151°) Drops: [1 x Banana, 15 x Mana Bead, 8 x Ceramics]'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:242,gy:144,n:'终端',r:'dlc2',d:'终端 (242° ,144°)'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:276,gy:159,n:'诺娜',r:'dlc2',d:'链塔 (276° ,159°) Nona'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:290,gy:142,n:'后勤入口',r:'dlc2',d:'营火 (290° ,142°) Logistics Entrance'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:310,gy:145,n:'锯木厂建设基础',r:'dlc2',qid:'q_dlc2_702294',qt:'side',d:'支线任务 (310° ,145°) Sawmill Building Basics'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:397,gy:144,n:'末日传说钓点',r:'dlc2',d:'钓鱼点 (397° ,144°) Doomsday\'s Legendary Spot'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:491,gy:143,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (491° ,143°) Drops: [1 x Electronics]'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:505,gy:155,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (505° ,155°) Drops: [1 x Steel]'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:508,gy:143,n:'可修复',r:'dlc2',d:'吊桥 (508° ,143°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:513,gy:150,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (513° ,150°) Drops: [1 x Scrap Fabric]'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:539,gy:146,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (539° ,146°)'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:524,gy:147,n:'废料场入口终端',r:'dlc2',d:'终端 (524° ,147°) Scrapyard Entrance Terminal'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:537,gy:152,n:'废料场入口',r:'dlc2',d:'营火 (537° ,152°) Scrapyard Entrance'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:547,gy:146,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (547° ,146°) Doomsday\'s Good Spot'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:639,gy:144,n:'莫塔空运补给站',r:'dlc2',d:'营火 (639° ,144°) Morta Aerial Resupply Depot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:667,gy:151,n:'末日传说钓点',r:'dlc2',d:'钓鱼点 (667° ,151°) Doomsday\'s Legendary Spot'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:681,gy:157,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (681° ,157°)'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:781,gy:156,n:'限时箱子',r:'dlc2',d:'限时箱子 (781° ,156°) Time Available: 15 seconds Rewards: [1 x Blue Eye Orb]'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:840,gy:151,n:'末日传说钓点',r:'dlc2',d:'钓鱼点 (840° ,151°) Doomsday\'s Legendary Spot'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:128,gy:164,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (128° ,164°) Drops: [4 x Wood, 6 x Rubber, 1 x Truffle]'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:143,gy:172,n:'翻开新一页',r:'dlc2',qid:'q_dlc2_782322',qt:'side',d:'支线任务 (143° ,172°) Turn Over A New Leaf'},
  {tp:'resource',ic:'icon-unknown',cl:'#94a3b8',gx:144,gy:166,n:'',r:'dlc2',d:'Doghouse (144° ,166°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:152,gy:171,n:'科林伍德',r:'dlc2',d:'营火 (152° ,171°) Collingwood'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:268,gy:162,n:'熔炉建设基础',r:'dlc2',qid:'q_dlc2_794240',qt:'side',d:'支线任务 (268° ,162°) Smelter Building Basics'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:298,gy:161,n:'终端',r:'dlc2',d:'终端 (298° ,162°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:302,gy:168,n:'末日传说钓点',r:'dlc2',d:'钓鱼点 (302° ,168°) Doomsday\'s Legendary Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:331,gy:161,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (331° ,161°) Doomsday\'s Good Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:426,gy:166,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (426° ,166°) Doomsday\'s Good Spot'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:479,gy:166,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (479° ,166°) Required Quest: On to the Scrap Heap [Side Quest] Key Drops: [Scrapyard'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:477,gy:171,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (477° ,171°) Doomsday\'s Good Spot'},
  {tp:'resource',ic:'icon-unknown',cl:'#94a3b8',gx:478,gy:168,n:'',r:'dlc2',d:'Doghouse (478° ,168°)'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:678,gy:173,n:'DLC2 深渊',r:'dlc2',d:'音频日志 (678° ,173°) Dlc2 Abyss'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:117,gy:181,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (117° ,181°) Doomsday\'s Good Spot'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:160,gy:195,n:'限时箱子',r:'dlc2',d:'限时箱子 (160° ,195°) Time Available: 15 seconds Rewards: [1 x Blue Eye Orb]'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:162,gy:185,n:'神力裂隙',r:'dlc2',d:'神力裂隙 (162° ,185°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:231,gy:197,n:'诺娜综合体外部基地',r:'dlc2',d:'营火 (231° ,197°) Nona Complex Exterior Base'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:300,gy:191,n:'阿提卡',r:'dlc2',d:'营火 (300° ,191°) Attica'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:312,gy:196,n:'打击地球',r:'dlc2',qid:'q_dlc2_894108',qt:'side',d:'支线任务 (312° ,196°) Strike the Earth'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:445,gy:183,n:'德西玛综合体北部',r:'dlc2',d:'营火 (445° ,183°) North of Decima Complex'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:539,gy:193,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (539° ,193°) Doomsday\'s Good Spot'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:554,gy:182,n:'前往废铁场',r:'dlc2',qid:'q_dlc2_918129',qt:'side',d:'支线任务 (554° ,182°) On to the Scrap Heap'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:583,gy:187,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (583° ,187°) Doomsday\'s Good Spot'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:617,gy:185,n:'魔剑传说',r:'dlc2',qid:'q_dlc2_924244',qt:'side',d:'支线任务 (617° ,185°) The Legend of the Magic Sword'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:708,gy:184,n:'莫塔综合体停车区',r:'dlc2',d:'营火 (708° ,184°) Morta Complex Parking Area'},
  {tp:'resource',ic:'icon-hatch',cl:'#94a3b8',gx:758,gy:186,n:'避难所',r:'dlc2',d:'避难所 (758° ,186°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:798,gy:186,n:'时间研究室入口',r:'dlc2',d:'营火 (798° ,186°) Temporal Laboratory Entrance'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:784,gy:191,n:'可修复',r:'dlc2',d:'吊桥 (784° ,192°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:813,gy:182,n:'神力裂隙',r:'dlc2',d:'神力裂隙 (813° ,182°)'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:190,gy:218,n:'可修复',r:'dlc2',d:'吊桥 (190° ,218°)'},
  {tp:'resource',ic:'icon-buried-teleporter',cl:'#c084fc',gx:217,gy:219,n:'传送宝藏',r:'dlc2',d:'埋藏宝藏 (217° ,219°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:251,gy:202,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (251° ,202°) Drops: [4 x Gold Bar]'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:339,gy:201,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (339° ,201°) Drops: [6 x Scrap Electronics, 4 x Wood]'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:376,gy:200,n:'可修复',r:'dlc2',d:'吊桥 (376° ,200°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:500,gy:214,n:'人员宿舍',r:'dlc2',d:'营火 (500° ,214°) Personnel Dormitory'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:536,gy:215,n:'限时箱子',r:'dlc2',d:'限时箱子 (536° ,215°) Time Available: 15 seconds Rewards: [1 x Blue Eye Orb]'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:570,gy:219,n:'活体标本研究室外',r:'dlc2',d:'营火 (570° ,219°) Outside Live Specimen Study'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:673,gy:205,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (673° ,205°) Doomsday\'s Good Spot'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:673,gy:213,n:'神力裂隙',r:'dlc2',d:'神力裂隙 (673° ,213°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:671,gy:217,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (671° ,217°) Drops: [8 x Gold Bar]'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:752,gy:211,n:'莫塔主发电机外',r:'dlc2',d:'营火 (752° ,211°) Outside Morta Main Generator'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:756,gy:215,n:'终端',r:'dlc2',d:'终端 (756° ,215°)'},
  {tp:'resource',ic:'icon-unknown',cl:'#94a3b8',gx:785,gy:216,n:'',r:'dlc2',d:'Doghouse (785° ,216°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:807,gy:208,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (807° ,208°) Doomsday\'s Good Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:835,gy:204,n:'末日传说钓点',r:'dlc2',d:'钓鱼点 (835° ,204°) Doomsday\'s Legendary Spot'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:151,gy:230,n:'诺娜空运补给站',r:'dlc2',d:'营火 (151° ,230°) Nona Aerial Supply Depot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:242,gy:233,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (242° ,233°) Doomsday\'s Good Spot'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:301,gy:238,n:'可修复',r:'dlc2',d:'吊桥 (301° ,238°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:326,gy:235,n:'神力裂隙',r:'dlc2',d:'神力裂隙 (326° ,235°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:381,gy:226,n:'末日传说钓点',r:'dlc2',d:'钓鱼点 (381° ,226°) Doomsday\'s Legendary Spot'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:419,gy:227,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (419° ,227°) Drops: [12 x Iron, 18 x Wood]'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:435,gy:238,n:'限时箱子',r:'dlc2',d:'限时箱子 (435° ,238°) Time Available: 15 seconds Rewards: [1 x Blue Eye Orb]'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:502,gy:224,n:'终端',r:'dlc2',d:'终端 (502° ,224°)'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:538,gy:222,n:'活体标本研究区终端',r:'dlc2',d:'终端 (538° ,222°) Live Specimen Study Area Terminal'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:664,gy:232,n:'神力裂隙',r:'dlc2',d:'神力裂隙 (664° ,232°)'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:696,gy:224,n:'发电子综合体终端',r:'dlc2',d:'终端 (696° ,224°) Power Generation Subcomplex Terminal'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:775,gy:239,n:'限时箱子',r:'dlc2',d:'限时箱子 (775° ,239°) Time Available: 12 seconds Rewards: [1 x Blue Eye Orb]'},
  {tp:'resource',ic:'icon-entryway',cl:'#86efac',gx:147,gy:259,n:'DLC2 无人机返回主岛',r:'dlc2',d:'Entryway (147° ,259°) Dlc2 Drone To Main Island'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:161,gy:247,n:'末日普通钓点',r:'dlc2',d:'钓鱼点 (161° ,247°) Doomsday\'s Common Spot'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:310,gy:249,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (310° ,249°) Required Quest: Treasure Hunt [Side Quest] Drops: [4 x Steel, 4 x Lumbe'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:315,gy:246,n:'神力裂隙',r:'dlc2',d:'神力裂隙 (315° ,246°)'},
  {tp:'resource',ic:'icon-buried-teleporter',cl:'#c084fc',gx:377,gy:248,n:'传送宝藏',r:'dlc2',d:'埋藏宝藏 (377° ,248°) To: Circuitry Contraption'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:413,gy:255,n:'植物实验室大门终端',r:'dlc2',d:'终端 (413° ,255°) Botanical Laboratory Gate Terminal'},
  {tp:'resource',ic:'icon-fabricator',cl:'#4ade80',gx:418,gy:251,n:'加工厂',r:'dlc2',d:'制造厂 (418° ,252°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:436,gy:254,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (436° ,254°) Drops: [7 x Gold Ore]'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:421,gy:258,n:'花之力永存',r:'dlc2',qid:'q_dlc2_1194251',qt:'side',d:'支线任务 (421° ,258°) Flower Power Forever'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:455,gy:259,n:'终端',r:'dlc2',d:'终端 (456° ,259°)'},
  {tp:'boss',ic:'icon-boss',cl:'#ef4444',gx:513,gy:244,n:'BOSS',r:'dlc2',d:'BOSS (513° ,244°) '},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:543,gy:249,n:'停尸间',r:'dlc2',d:'营火 (543° ,249°) Morgue'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:589,gy:256,n:'末日传说钓点',r:'dlc2',d:'钓鱼点 (589° ,256°) Doomsday\'s Legendary Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:619,gy:251,n:'末日普通钓点',r:'dlc2',d:'钓鱼点 (619° ,251°) Doomsday\'s Common Spot'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:653,gy:241,n:'神力裂隙',r:'dlc2',d:'神力裂隙 (653° ,241°)'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:682,gy:258,n:'莫塔',r:'dlc2',d:'链塔 (682° ,258°) Morta'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:689,gy:254,n:'龙门吊架入口',r:'dlc2',d:'营火 (689° ,254°) The Gantry Entrance'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:708,gy:243,n:'龙门吊架桥梁终端',r:'dlc2',d:'终端 (708° ,243°) The Gantry Bridge Terminal'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:708,gy:257,n:'龙门吊架大门终端',r:'dlc2',d:'终端 (708° ,257°) The Gantry Gate Terminal'},
  {tp:'boss',ic:'icon-boss',cl:'#ef4444',gx:723,gy:250,n:'龙门吊架',r:'dlc2',d:'BOSS (723° ,250°) Gantry'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:813,gy:257,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (813° ,257°) Drops: [4 x Gold Bar, 1 x Central Processing Unit]'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:359,gy:275,n:'寻宝之旅',r:'dlc2',qid:'q_dlc2_1282181',qt:'side',d:'支线任务 (359° ,275°) Treasure Hunt'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:365,gy:277,n:'红藤便利店',r:'dlc2',d:'营火 (365° ,277°) Redwicket Convenience Store'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:399,gy:277,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (399° ,277°) Drops: [6 x Steel, 16 x Ceramics]'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:410,gy:260,n:'植物实验室外',r:'dlc2',d:'营火 (410° ,260°) Outside Botanical Labs'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:443,gy:277,n:'北德西玛',r:'dlc2',d:'链塔 (443° ,277°) North Decima'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:450,gy:263,n:'德西玛综合体庭院',r:'dlc2',d:'营火 (450° ,263°) Decima Complex Courtyard'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:486,gy:268,n:'终端',r:'dlc2',d:'终端 (486° ,268°)'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:519,gy:262,n:'DLC2 面纱',r:'dlc2',d:'音频日志 (519° ,262°) Dlc2 The Veil'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:542,gy:278,n:'终端',r:'dlc2',d:'终端 (542° ,278°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:667,gy:266,n:'神力裂隙',r:'dlc2',d:'神力裂隙 (667° ,266°)'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:686,gy:261,n:'终端',r:'dlc2',d:'终端 (686° ,262°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:749,gy:273,n:'莫塔综合体东出口',r:'dlc2',d:'营火 (749° ,273°) Morta Complex Eastern Exit'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:291,gy:287,n:'红藤扩建工地',r:'dlc2',d:'营火 (291° ,287°) Redwicket Expansion Site'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:428,gy:295,n:'终端',r:'dlc2',d:'终端 (428° ,295°)'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:449,gy:296,n:'DLC2 晋升',r:'dlc2',d:'音频日志 (449° ,296°) Dlc2 Promotion'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:491,gy:280,n:'终端',r:'dlc2',d:'终端 (491° ,280°)'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:534,gy:291,n:'诺娜后勤区大门终端',r:'dlc2',d:'终端 (534° ,292°) Nona Logistics Area Gate Terminal'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:584,gy:286,n:'优质钓点',r:'dlc2',d:'钓鱼点 (584° ,286°) Good Spot'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:610,gy:286,n:'死胡同营地',r:'dlc2',d:'营火 (610° ,286°) Dead End Camp'},
  {tp:'resource',ic:'icon-buried-teleporter',cl:'#c084fc',gx:628,gy:282,n:'传送宝藏',r:'dlc2',d:'埋藏宝藏 (628° ,282°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:635,gy:291,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (635° ,291°) Doomsday\'s Good Spot'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:675,gy:281,n:'神力裂隙',r:'dlc2',d:'神力裂隙 (675° ,281°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:705,gy:297,n:'埋藏宝藏',r:'dlc2',d:'埋藏宝藏 (705° ,297°) Drops: [2 x Gold Bar, 2 x Titanium, 1 x Mana Shard]'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:726,gy:293,n:'DLC2 证据',r:'dlc2',d:'音频日志 (726° ,293°) Dlc2 Evidence'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:789,gy:281,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (789° ,281°) Doomsday\'s Good Spot'},
  ...
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:317,gy:307,n:'可修复',r:'dlc2',d:'吊桥 (317° ,307°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:534,gy:312,n:'发掘古墓附近',r:'dlc2',d:'营火 (534° ,312°) Near Excavated Tomb'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:250,gy:328,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (250° ,328°) Doomsday\'s Good Spot'},
  {tp:'resource',ic:'icon-buried-teleporter',cl:'#c084fc',gx:284,gy:332,n:'传送宝藏',r:'dlc2',d:'埋藏宝藏 (284° ,332°) To: Angora Activation'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:477,gy:329,n:'德西玛安全实验室',r:'dlc2',d:'营火 (477° ,329°) Decima Secure Laboratory'},
  {tp:'resource',ic:'icon-hatch',cl:'#94a3b8',gx:482,gy:329,n:'避难所',r:'dlc2',d:'避难所 (482° ,329°)'},
  {tp:'tomb',ic:'icon-tomb',cl:'#a78bfa',gx:532,gy:331,n:'古墓',r:'dlc2',d:'Tomb (532° ,332°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:555,gy:333,n:'无人机控制中心外',r:'dlc2',d:'营火 (555° ,333°) Outside Drone Control Center'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:289,gy:352,n:'末日普通钓点',r:'dlc2',d:'钓鱼点 (289° ,352°) Doomsday\'s Common Spot'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:362,gy:350,n:'可修复',r:'dlc2',d:'吊桥 (362° ,350°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:383,gy:357,n:'优质钓点',r:'dlc2',d:'钓鱼点 (383° ,357°) Good Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:413,gy:348,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (413° ,348°) Doomsday\'s Good Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:508,gy:342,n:'优质钓点',r:'dlc2',d:'钓鱼点 (508° ,342°) Good Spot'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:291,gy:363,n:'海滩营地',r:'dlc2',d:'营火 (291° ,363°) Encampment by the Beach'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:358,gy:368,n:'末日优质钓点',r:'dlc2',d:'钓鱼点 (358° ,368°) Doomsday\'s Good Spot'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:383,gy:377,n:'奥里诺科',r:'dlc2',d:'营火 (383° ,377°) Orinoko'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:466,gy:375,n:'末日普通钓点',r:'dlc2',d:'钓鱼点 (466° ,375°) Doomsday\'s Common Spot'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:370,gy:395,n:'南德西玛',r:'dlc2',d:'链塔 (370° ,396°) South Decima'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:402,gy:398,n:'可修复',r:'dlc2',d:'吊桥 (402° ,398°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:440,gy:418,n:'末日传说钓点',r:'dlc2',d:'钓鱼点 (440° ,418°) Doomsday\'s Legendary Spot'},
];
...
// ── 宠物地下城 (dlc3) ──
const MD_DLC3=[
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:134,gy:40,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (134° ,40°)'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:162,gy:37,n:'可修复',r:'dlc3',d:'吊桥 (162° ,37°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:248,gy:35,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (248° ,35°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:302,gy:37,n:'优质钓点',r:'dlc3',d:'钓鱼点 (302° ,37°) Good Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:63,gy:58,n:'传说级神力钓点',r:'dlc3',d:'钓鱼点 (63° ,58°) Legendary Mana Spot'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:143,gy:58,n:'限时箱子',r:'dlc3',d:'限时箱子 (143° ,58°) Time Available: 17 seconds Rewards: [3 x Lumber, 1 x Mana Chunk]'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:176,gy:51,n:'冰霜之地入口',r:'dlc3',d:'营火 (176° ,51°) Frostarium Entrance'},
  {tp:'resource',ic:'icon-entryway',cl:'#86efac',gx:166,gy:46,n:'冰霜传送器入口',r:'dlc3',d:'Entryway (166° ,46°) Entry Winter'},
  ...
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:216,gy:50,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (216° ,50°) Drops: [7 x Rubber, 2 x Iron]'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:239,gy:53,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (239° ,53°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:251,gy:40,n:'优质钓点',r:'dlc3',d:'钓鱼点 (252° ,40°) Good Spot'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:296,gy:56,n:'植物园加油站',r:'dlc3',d:'营火 (296° ,56°) Arboretum Gas Station'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:301,gy:57,n:'植物园',r:'dlc3',d:'链塔 (301° ,57°) Arboretum'},
  {tp:'resource',ic:'icon-unknown',cl:'#94a3b8',gx:362,gy:46,n:'',r:'dlc3',d:'Doghouse (362° ,46°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:88,gy:70,n:'优质钓点',r:'dlc3',d:'钓鱼点 (88° ,70°) Good Spot'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:100,gy:72,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (100° ,72°) Drops: [1 x Mana Chunk]'},
  {tp:'boss',ic:'icon-boss',cl:'#ef4444',gx:107,gy:63,n:'冰霜巨兽',r:'dlc3',d:'BOSS (107° ,63°) The Beast of Frost'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:122,gy:63,n:'可修复',r:'dlc3',d:'吊桥 (122° ,63°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:142,gy:77,n:'冰霜之地山脚',r:'dlc3',d:'营火 (142° ,77°) Frostarium Underhill'},
  {tp:'resource',ic:'icon-wishing-well',cl:'#f0abfc',gx:149,gy:66,n:'许愿井',r:'dlc3',d:'Wishing Well (150° ,66°)'},
  {tp:'resource',ic:'icon-terminal',cl:'#4cc9f0',gx:218,gy:76,n:'冰霜之地桥门终端',r:'dlc3',d:'终端 (218° ,76°) Frostarium Bridge Gate'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:232,gy:62,n:'DLC3 广告1',r:'dlc3',d:'音频日志 (232° ,62°) Dlc3 Ad1'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:266,gy:73,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (266° ,74°) Drops: [7 x Berries]'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:292,gy:80,n:'限时箱子',r:'dlc3',d:'限时箱子 (292° ,80°) Time Available: 8 seconds Rewards: [5 x Electronics, 5 x Lumber]'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:315,gy:80,n:'可修复',r:'dlc3',d:'吊桥 (315° ,80°)'},
  {tp:'resource',ic:'icon-unknown',cl:'#94a3b8',gx:334,gy:74,n:'',r:'dlc3',d:'Doghouse (334° ,74°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:334,gy:73,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (334° ,73°) Drops: [3 x Rubber]'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:352,gy:62,n:'植物园入口',r:'dlc3',d:'营火 (352° ,62°) Arboretum Entrance'},
  {tp:'resource',ic:'icon-entryway',cl:'#86efac',gx:368,gy:64,n:'森林传送器入口',r:'dlc3',d:'Entryway (368° ,64°) Entry Forest'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:386,gy:73,n:'优质钓点',r:'dlc3',d:'钓鱼点 (386° ,73°) Good Spot'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:45,gy:80,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (45° ,80°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:74,gy:98,n:'优质钓点',r:'dlc3',d:'钓鱼点 (74° ,98°) Good Spot'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:126,gy:88,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (126° ,88°)'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:168,gy:87,n:'冰霜之地',r:'dlc3',d:'链塔 (168° ,87°) Frostarium'},
  {tp:'boss',ic:'icon-boss',cl:'#ef4444',gx:255,gy:97,n:'树林巨兽',r:'dlc3',d:'BOSS (255° ,97°) The Beast of Timber'},
  ...
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:289,gy:88,n:'独狼们',r:'dlc3',qid:'q_dlc3_220365',qt:'side',d:'支线任务 (289° ,88°) Lone Wolves'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:316,gy:92,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (316° ,92°) Drops: [5 x Wood, 2 x Lumber]'},
  ...
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:331,gy:89,n:'优质钓点',r:'dlc3',d:'钓鱼点 (331° ,89°) Good Spot'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:328,gy:93,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (328° ,93°)'},
  {tp:'resource',ic:'icon-wishing-well',cl:'#f0abfc',gx:351,gy:96,n:'许愿井',r:'dlc3',d:'Wishing Well (352° ,96°)'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:358,gy:84,n:'DLC3 广告4',r:'dlc3',d:'音频日志 (358° ,84°) Dlc3 Ad4'},
  {tp:'resource',ic:'icon-unknown',cl:'#94a3b8',gx:368,gy:81,n:'',r:'dlc3',d:'Doghouse (368° ,81°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:403,gy:99,n:'末日普通钓点',r:'dlc3',d:'钓鱼点 (403° ,99°) Doomsday\'s Common Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:403,gy:95,n:'末日普通钓点',r:'dlc3',d:'钓鱼点 (403° ,95°) Doomsday\'s Common Spot'},
  {tp:'boss',ic:'icon-boss',cl:'#ef4444',gx:420,gy:91,n:'实验室守卫',r:'dlc3',d:'BOSS (420° ,91°) The Lab Guardian'},
  ...
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:58,gy:102,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (58° ,102°)'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:99,gy:107,n:'限时箱子',r:'dlc3',d:'限时箱子 (99° ,107°) Time Available: 8 seconds Rewards: [1 x Mana Chunk]'},
  {tp:'resource',ic:'icon-lock',cl:'#4ade80',gx:80,gy:115,n:'',r:'dlc3',d:'Locked Door (80° ,115°) Old Vault Room Key'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:137,gy:106,n:'水域',r:'dlc3',d:'钓鱼点 (137° ,106°) Water'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:158,gy:104,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (158° ,104°) Drops: [24 x Plant Matter, 12 x Bone]'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:233,gy:116,n:'DLC3 广告3',r:'dlc3',d:'音频日志 (233° ,116°) Dlc3 Ad3'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:248,gy:119,n:'病房实验室',r:'dlc3',d:'营火 (248° ,119°) Ward\'s Lab'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:273,gy:100,n:'可修复',r:'dlc3',d:'吊桥 (273° ,100°)'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:262,gy:117,n:'限时箱子',r:'dlc3',d:'限时箱子 (262° ,117°) Time Available: 10 seconds Rewards: [2 x Mana Shard]'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:295,gy:112,n:'传说级钓点',r:'dlc3',d:'钓鱼点 (295° ,112°) Legendary Spot'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:294,gy:102,n:'被包围的农场',r:'dlc3',qid:'q_dlc3_268197',qt:'key',d:'主线任务 (294° ,102°) Surrounded Farm'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:312,gy:116,n:'奇异钓点',r:'dlc3',d:'钓鱼点 (312° ,116°) Weird Spot'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:323,gy:103,n:'可修复',r:'dlc3',d:'吊桥 (323° ,103°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:354,gy:104,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (354° ,104°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:40,gy:120,n:'神力钓点',r:'dlc3',d:'钓鱼点 (40° ,120°) Mana Spot'},
  {tp:'boss',ic:'icon-boss',cl:'#ef4444',gx:56,gy:125,n:'守地人',r:'dlc3',d:'BOSS (56° ,125°) The Groundskeeper'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:88,gy:122,n:'魔法岛入口',r:'dlc3',d:'营火 (88° ,122°) Isle of Mana Entrance'},
  {tp:'resource',ic:'icon-entryway',cl:'#86efac',gx:97,gy:125,n:'冥界传送器入口',r:'dlc3',d:'Entryway (97° ,125°) Entry Dlc1'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:143,gy:135,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (143° ,135°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:168,gy:129,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (168° ,129°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:186,gy:122,n:'奇异钓点',r:'dlc3',d:'钓鱼点 (186° ,122°) Weird Spot'},
  {tp:'resource',ic:'icon-lock3',cl:'#4ade80',gx:204,gy:134,n:'',r:'dlc3',d:'Locked Door (204° ,134°) Master Lockpick'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:232,gy:120,n:'生态中心',r:'dlc3',d:'链塔 (232° ,120°) Vivarium Nexus'},
  ...
  {tp:'resource',ic:'icon-entryway',cl:'#86efac',gx:240,gy:120,n:'奖励室入口',r:'dlc3',d:'Entryway (240° ,120°) Entry Reward Room'},
  {tp:'resource',ic:'icon-entryway',cl:'#86efac',gx:240,gy:130,n:'宠物岛中心电梯',r:'dlc3',d:'Entryway (240° ,130°) Pet Isle Center Elevator'},
  {tp:'resource',ic:'icon-audio-log',cl:'#94a3b8',gx:259,gy:125,n:'DLC3 广告2',r:'dlc3',d:'音频日志 (259° ,125°) Dlc3 Ad2'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:331,gy:121,n:'可修复',r:'dlc3',d:'吊桥 (331° ,121°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:378,gy:120,n:'末日岛北部',r:'dlc3',d:'营火 (378° ,120°) Isle of Doom North'},
  ...
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:74,gy:152,n:'魔法岛',r:'dlc3',d:'链塔 (74° ,152°) Isle of Mana'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:138,gy:152,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (138° ,152°)'},
  {tp:'resource',ic:'icon-lock3',cl:'#4ade80',gx:184,gy:151,n:'',r:'dlc3',d:'Locked Door (184° ,151°) Master Lockpick'},
  {tp:'boss',ic:'icon-boss',cl:'#ef4444',gx:216,gy:144,n:'荒漠巨兽',r:'dlc3',d:'BOSS (216° ,144°) The Beast of Desolation'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:214,gy:156,n:'B营房卡车停靠点',r:'dlc3',d:'营火 (214° ,156°) Barracks B Truck Stop'},
  {tp:'boss',ic:'icon-boss',cl:'#ef4444',gx:254,gy:141,n:'大地巨兽',r:'dlc3',d:'BOSS (254° ,141°) The Beast of Terra'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:279,gy:146,n:'玻璃花园',r:'dlc3',d:'链塔 (279° ,146°) Terrarium'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:272,gy:154,n:'智慧之地篮球场',r:'dlc3',d:'营火 (272° ,154°) Wisdom\'s Basketball Field'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:293,gy:143,n:'可修复',r:'dlc3',d:'吊桥 (293° ,143°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:300,gy:158,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (300° ,158°) Drops: [1 x Scrap Electronics, 1 x Corn]'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:311,gy:153,n:'遗忘的智慧',r:'dlc3',qid:'q_dlc3_366227',qt:'side',d:'支线任务 (311° ,153°) Forgotten Wisdom'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:323,gy:141,n:'奇异钓点',r:'dlc3',d:'钓鱼点 (323° ,141°) Weird Spot'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:336,gy:156,n:'优质钓点',r:'dlc3',d:'钓鱼点 (336° ,156°) Good Spot'},
  {tp:'resource',ic:'icon-entryway',cl:'#86efac',gx:381,gy:144,n:'末日传送器入口',r:'dlc3',d:'Entryway (381° ,144°) Entry Dlc2'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:402,gy:146,n:'末日岛',r:'dlc3',d:'链塔 (402° ,146°) Isle of Doom'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:405,gy:140,n:'末日岛南部',r:'dlc3',d:'营火 (405° ,140°) Isle of Doom South'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:64,gy:166,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (64° ,166°) Required Quest: The Underdog [Side Quest] Drops: [4 x Bone, 1 x Mana Bea'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:67,gy:176,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (67° ,176°) Required Quest: The Underdog [Side Quest] Drops: [3 x Mana Bead, 1 x Bon'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:87,gy:172,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (87° ,172°) Required Quest: The Underdog [Side Quest] Drops: [4 x Bone, 1 x Mana Bea'},
  ...
  {tp:'resource',ic:'icon-hatch',cl:'#94a3b8',gx:181,gy:168,n:'避难所',r:'dlc3',d:'避难所 (181° ,168°)'},
  {tp:'tower',ic:'icon-link-tower',cl:'#fb923c',gx:216,gy:161,n:'荒漠',r:'dlc3',d:'链塔 (216° ,161°) Desolatum'},
  {tp:'quest',ic:'icon-quest',cl:'#60a5fa',gx:201,gy:175,n:'宠物失窃',r:'dlc3',qid:'q_dlc3_404211',qt:'side',d:'支线任务 (201° ,175°) Stolen Pet'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:314,gy:161,n:'可修复',r:'dlc3',d:'吊桥 (314° ,162°)'},
  {tp:'resource',ic:'icon-fixable',cl:'#4ade80',gx:305,gy:169,n:'可修复',r:'dlc3',d:'吊桥 (305° ,169°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:329,gy:177,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (329° ,177°)'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:350,gy:176,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (350° ,176°)'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:365,gy:167,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (365° ,167°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:380,gy:173,n:'末日传说钓点',r:'dlc3',d:'钓鱼点 (380° ,173°) Doomsday\'s Legendary Spot'},
  {tp:'resource',ic:'icon-unknown',cl:'#94a3b8',gx:408,gy:175,n:'',r:'dlc3',d:'Doghouse (408° ,175°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:429,gy:172,n:'末日普通钓点',r:'dlc3',d:'钓鱼点 (429° ,172°) Doomsday\'s Common Spot'},
  {tp:'resource',ic:'icon-lock',cl:'#4ade80',gx:420,gy:169,n:'',r:'dlc3',d:'Locked Door (420° ,169°) Vault Room Key'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:55,gy:181,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (55° ,181°) Required Quest: The Underdog [Side Quest] Drops: [4 x Bone, 1 x Mana Bea'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:63,gy:194,n:'优质钓点',r:'dlc3',d:'钓鱼点 (63° ,194°) Good Spot'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:89,gy:184,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (89° ,184°) Required Quest: The Underdog [Side Quest] Drops: [4 x Bone, 1 x Mana Bea'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:142,gy:191,n:'优质钓点',r:'dlc3',d:'钓鱼点 (142° ,191°) Good Spot'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:154,gy:184,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (154° ,184°)'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:178,gy:182,n:'荒漠基地',r:'dlc3',d:'营火 (178° ,182°) Desolatum Base'},
  {tp:'resource',ic:'icon-entryway',cl:'#86efac',gx:166,gy:188,n:'荒漠传送器入口',r:'dlc3',d:'Entryway (166° ,188°) Entry Desert'},
  {tp:'treasure',ic:'icon-chest',cl:'#fbbf24',gx:206,gy:199,n:'限时箱子',r:'dlc3',d:'限时箱子 (206° ,199°) Time Available: 20 seconds Rewards: [3 x Mana Chunk]'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:226,gy:184,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (226° ,184°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:262,gy:182,n:'优质钓点',r:'dlc3',d:'钓鱼点 (262° ,182°) Good Spot'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:287,gy:190,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (287° ,190°)'},
  {tp:'resource',ic:'icon-entryway',cl:'#86efac',gx:313,gy:197,n:'远古传送器入口',r:'dlc3',d:'Entryway (313° ,197°) Entry Ancient'},
  {tp:'treasure',ic:'icon-buried-treasure',cl:'#fbbf24',gx:304,gy:186,n:'埋藏宝藏',r:'dlc3',d:'埋藏宝藏 (304° ,186°) Drops: [2 x Plastics, 3 x Hide, 6 x Iron]'},
  {tp:'campfire',ic:'icon-campfire',cl:'#ff7043',gx:321,gy:189,n:'玻璃花园十字路口',r:'dlc3',d:'营火 (321° ,189°) Terrarium Crossroads'},
  {tp:'rift',ic:'icon-rift',cl:'#c084fc',gx:395,gy:188,n:'神力裂隙',r:'dlc3',d:'神力裂隙 (395° ,188°)'},
  {tp:'fishing',ic:'icon-fishing-spot',cl:'#38bdf8',gx:285,gy:200,n:'优质钓点',r:'dlc3',d:'钓鱼点 (285° ,200°) Good Spot'},
];
...
// DLC Quest Data
QD['q_dlc1_516186']={t:'side',n:'使用增强型种子袋',en:'Farming with Enhanced Seed Bag',mapId:'dlc1',s:['支线任务 (366° ,102°) 使用增强型种子袋'],rw:'',locs:[{label:'使用增强型种子袋',gx:366,gy:102,tp:'start'}]};
QD['q_dlc1_548169']={t:'side',n:'锯木厂建设基础',mapId:'dlc1',s:['支线任务 (684° ,109°) 锯木厂建设基础'],rw:'',locs:[{label:'锯木厂建设基础',gx:683,gy:109,tp:'start'}]};
QD['q_dlc1_846171']={t:'side',n:'往事储存库',en:'Vault into Past',mapId:'dlc1',s:['支线任务 (793° ,165°) 往事储存库'],rw:'',locs:[{label:'往事储存库',gx:793,gy:165,tp:'start'}]};
QD['q_dlc1_1118254']={t:'side',n:'锯木厂建设基础',mapId:'dlc1',s:['支线任务 (640° ,226°) 锯木厂建设基础'],rw:'',locs:[{label:'锯木厂建设基础',gx:640,gy:226,tp:'start'}]};
QD['q_dlc1_1502119']={t:'side',n:'使用增强型种子袋',en:'Farming with Enhanced Seed Bag',mapId:'dlc1',s:['支线任务 (620° ,312°) 使用增强型种子袋'],rw:'',locs:[{label:'使用增强型种子袋',gx:620,gy:311,tp:'start'}]};
QD['q_dlc1_1584342']={t:'side',n:'绝望的存在',en:'Desperate Existence',mapId:'dlc1',s:['支线任务 (487° ,334°) 绝望的存在'],rw:'',locs:[{label:'绝望的存在',gx:487,gy:334,tp:'start'}]};
QD['q_dlc1_1684049']={t:'side',n:'熔炉建设基础',mapId:'dlc1',s:['支线任务 (526° ,358°) 熔炉建设基础'],rw:'',locs:[{label:'熔炉建设基础',gx:526,gy:358,tp:'start'}]};
QD['q_dlc1_1700229']={t:'key',n:'精神问题',en:'Spirit Trouble',mapId:'dlc1',s:['主线任务 (696° ,345°) 精神问题'],rw:'',locs:[{label:'精神问题',gx:696,gy:345,tp:'start'}]};
QD['q_dlc2_620311']={t:'side',n:'跟着流走',en:'Go With the Flow',mapId:'dlc2',s:['支线任务 (444° ,128°) 跟着流走'],rw:'',locs:[{label:'跟着流走',gx:444,gy:128,tp:'start'}]};
QD['q_dlc2_702294']={t:'side',n:'锯木厂建设基础',mapId:'dlc2',s:['支线任务 (310° ,145°) 锯木厂建设基础'],rw:'',locs:[{label:'锯木厂建设基础',gx:310,gy:145,tp:'start'}]};
QD['q_dlc2_782322']={t:'side',n:'翻开新一页',en:'Turn Over A New Leaf',mapId:'dlc2',s:['支线任务 (143° ,172°) 翻开新一页'],rw:'',locs:[{label:'翻开新一页',gx:143,gy:172,tp:'start'}]};
QD['q_dlc2_794240']={t:'side',n:'熔炉建设基础',mapId:'dlc2',s:['支线任务 (268° ,162°) 熔炉建设基础'],rw:'',locs:[{label:'熔炉建设基础',gx:268,gy:162,tp:'start'}]};
QD['q_dlc2_894108']={t:'side',n:'打击地球',en:'Strike the Earth',mapId:'dlc2',s:['支线任务 (312° ,196°) 打击地球'],rw:'',locs:[{label:'打击地球',gx:312,gy:196,tp:'start'}]};
QD['q_dlc2_918129']={t:'side',n:'前往废铁场',en:'On to the Scrap Heap',mapId:'dlc2',s:['支线任务 (554° ,182°) 前往废铁场'],rw:'',locs:[{label:'前往废铁场',gx:554,gy:182,tp:'start'}]};
QD['q_dlc2_924244']={t:'side',n:'魔剑传说',en:'The Legend of the Magic Sword',mapId:'dlc2',s:['支线任务 (617° ,185°) 魔剑传说'],rw:'',locs:[{label:'魔剑传说',gx:617,gy:185,tp:'start'}]};
QD['q_dlc2_1194251']={t:'side',n:'花之力永存',en:'Flower Power Forever',mapId:'dlc2',s:['支线任务 (421° ,258°) 花之力永存'],rw:'',locs:[{label:'花之力永存',gx:421,gy:258,tp:'start'}]};
QD['q_dlc2_1282181']={t:'side',n:'寻宝之旅',en:'Treasure Hunt',mapId:'dlc2',s:['支线任务 (359° ,275°) 寻宝之旅'],rw:'',locs:[{label:'寻宝之旅',gx:359,gy:275,tp:'start'}]};
QD['q_dlc3_220365']={t:'side',n:'独狼们',mapId:'dlc3',s:['支线任务 (289° ,88°) 独狼们'],rw:'',locs:[{label:'独狼们',gx:289,gy:88,tp:'start'}]};
QD['q_dlc3_268197']={t:'key',n:'被包围的农场',mapId:'dlc3',s:['主线任务 (294° ,102°) 被包围的农场'],rw:'',locs:[{label:'被包围的农场',gx:294,gy:102,tp:'start'}]};
QD['q_dlc3_366227']={t:'side',n:'遗忘的智慧',mapId:'dlc3',s:['支线任务 (311° ,153°) 遗忘的智慧'],rw:'',locs:[{label:'遗忘的智慧',gx:311,gy:153,tp:'start'}]};
QD['q_dlc3_404211']={t:'side',n:'宠物失窃',mapId:'dlc3',s:['支线任务 (201° ,175°) 宠物失窃'],rw:'',locs:[{label:'宠物失窃',gx:201,gy:175,tp:'start'}]};
...
function buildMarkers(){
  ...
  MD.forEach(m=>{
    ...
    h+=`<div class="pn">${m.n}</div><div class="pr">📍 ${m.r}</div><div class="pc">坐标: ${m.gx}°, ${m.gy}°</div>`;
    if(q){
...
function buildMarkersUC(){
  ...
  MD_UC.forEach(m=>{
    ...
    let h=`<div class="pi"><div class="pt">${TL[m.tp]||m.tp}</div>`;
    if(q){const bc={main:'bm',side:'bs',key:'bk'}[m.qt]||'bs';h+=`<span class="pbadge ${bc}">${{main:'主线',side:'支线',key:'关键支线'}[m.qt]}</span><br>`;}
    h+=`<div class="pn">${m.n}</div><div class="pr">📍 地下城</div><div class="pc">坐标: ${m.gx}°, ${m.gy}°</div>`;
    if(q){
      h+=`<div class="pdiv"></div><div class="pqt">${q.n}</div>`;
      q.s.forEach(s=>{h+=`<div class="ps">${s}</div>`;});
      h+=`<div class="prew">${q.rw}</div>`;
...
function buildMarkersDLC(mdArr, layerGroup, toLatLng){
  ...
  mdArr.forEach(m=>{
    ...
    h+=`<div class="pn">${displayName}</div><div class="pr">📍 ${mapLabel}</div><div class="pc">坐标: ${m.gx}°, ${m.gy}°</div>`;
